...
from .models import EntityMention, EntityLinkingResult
...
class SpacyNER:
    ...
    def __init__(self, model_name: str = "en_core_web_sm", disable_components: Optional[List[str]] = None):
    ...
    def extract_entities(self, text: str, entity_types: Optional[Set[str]] = None) -> List[EntityMention]:
...
class EntityLinker:
    ...
    def __init__(
        ...
        semantic_model: Optional[SemanticSimilarity] = None
    ):
...
class NLPEngine:
    ...
    def enhance_name_search(
        ...
        nlp_results = self.process_text(text_corpus, extract_entities=True)
