...
def csv_to_json(input_path: Union[str, Path], output_path: Union[str, Path], **kwargs) -> None:
    """Convert CSV file to JSON format."""
    df = read_file(input_path, 'csv')
    write_file(df, output_path, 'json', **kwargs)


def csv_to_parquet(input_path: Union[str, Path], output_path: Union[str, Path], **kwargs) -> None:
    """Convert CSV file to Parquet format."""
    df = read_file(input_path, 'csv')
    write_file(df, output_path, 'parquet', **kwargs)


def json_to_csv(input_path: Union[str, Path], output_path: Union[str, Path], **kwargs) -> None:
    """Convert JSON file to CSV format."""
    df = read_file(input_path, 'json')
    write_file(df, output_path, 'csv', **kwargs)


def parquet_to_csv(input_path: Union[str, Path], output_path: Union[str, Path], **kwargs) -> None:
