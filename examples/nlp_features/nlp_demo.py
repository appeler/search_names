...
def demo_semantic_similarity():
    ...
    try:
        ...
        candidates = [
            "Joseph Biden", "President Biden", "Former VP Biden",
            "Donald Trump", "Barack Obama", "Kamala Harris",
...
def demo_full_nlp_pipeline():
    ...
    try:
        ...
        for link_result in results['linked_entities']:
            print(f"  '{link_result.mention.text}' -> {link_result.linked_entity_name or 'No match'}")
    ...
    try:
        ...
        for result in enhanced_results:
            ...
            for i, match in enumerate(matches[:3]):  # Show first 3 matches
                ...
                print(f"  Match {i+1}: {is_person and '👤' or '📍'} {'Person' if is_person else 'Other'}")
